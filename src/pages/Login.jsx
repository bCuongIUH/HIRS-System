...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Trong thực tế, bạn sẽ lưu token vào localStorage hoặc cookies
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-blue-600 flex-col justify-between">
        ...
        <div className="p-12 text-blue-100 text-sm">© 2025 HRIS System. Bản quyền thuộc về Công ty TNHH SKYDEV.</div>
      </div>
